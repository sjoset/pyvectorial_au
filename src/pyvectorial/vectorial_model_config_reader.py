...
"""
    Functionality for taking a YAML file and using it to construct a VectorialModelConfig
"""


# def vectorial_model_configs_from_yaml(
#     filepath: pathlib.Path,
# ) -> List[VectorialModelConfig]:
#     """
...
#     """
#
#     vmc = _vm_config_from_yaml(filepath)
#
...
#         if variable_key in vmc.production.params:  # type: ignore
#             allowed_variations.append(vmc.production.params[variable_key])  # type: ignore
